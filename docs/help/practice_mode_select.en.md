...
Use this page to pick which practice path to enter next, and to load or import a lexicon when needed. The top of the page shows the current lexicon status; the mini console in the middle reports results of load and import actions.

![](assets/practice_mode_select_en_1.webp)

### 1 Lexicon Practice

For practicing with the general Norwegian word bank. Workflow: load or import a lexicon first, then click **Lexicon Mode** to enter lexicon selection and practice.
